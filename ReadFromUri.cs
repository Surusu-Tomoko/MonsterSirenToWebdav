...
namespace MonsterSiren
{
    ...
    {
        public FileAbstraction(string file, Stream s)
        {
            Name = file;
            Streame = s;
        }
        ...
        public Stream Streame { get; }

        public Stream ReadStream => Streame;

        public Stream WriteStream => ResetStream();
